...
const CATEGORY_MAP = {
  tech: {
    ...
    key: "TECH",
    icon: "💻",
    desc: "Latest updates from the tech world.",
  },
  entertainment: {
    label: "Entertainment",
    key: "ENTERTAINMENT",
    icon: "🎬",
    desc: "Movies, music, celebrities and more.",
  },
  exams: {
    label: "Exams & Education",
    key: "EXAMS",
    icon: "📚",
    desc: "Exam alerts, study tips and results.",
  },
  others: {
    label: "Others",
    key: "Other",
  ...
  "how-to": {
    ...
    key: "OTHERS",
    icon: "🛠️",
    desc: "Step-by-step tutorials and tips.",
  },
  others: {
    label: "Other Stories",
    key: "OTHERS",
    icon: "📰",
    desc: "More stories from across the web.",
  },
};
