...
const CATEGORIES_DATA = [
    { icon: '💻', title: 'Technology', description: 'Latest tech news, gadgets, and innovation', to: '/category/tech' },
    { icon: '🎬', title: 'Entertainment', description: 'Movies, TV shows, celebrities, and more', to: '/category/entertainment' },
    { icon: '📚', title: 'Exams & Education', description: 'Exam updates, study tips, and results', to: '/category/exams' },
    { icon: '🛠️', title: 'How-To Guides', description: 'Step-by-step tutorials and tips', to: '/category/how-to' },
];
        ...
        <main>
            ...
            <section className="hero" role="banner">
                <div className="container">
                    ...
                    <p>Discover the latest in Technology, Sports, Entertainment, Education, and practical How-To Guides. Updated daily with stories that matter.</p>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <div className="grid grid-2">
                        {loading
                            ...
                            : featuredPosts.map(post => <FeaturedCard key={post.articleId || post.title} post={post} />)
                        }
                    </div>
                </div>
            </section>
            ...
            <section className="section" aria-labelledby="latest-heading">
                <div className="container">
                    <div className="content-with-sidebar">
                        {/* Main Column */}
                        <div>
                            <header className="section-header" style={{ marginBottom: '2rem', textAlign: 'left' }}>
                            ...
                            <div className="grid grid-3" role="feed">
                                {loading
                                    ...
                                    : visiblePosts.map(post => <PostCard key={post.articleId || post.title} post={post} />)
                                }
                            </div>
            ...
            <section className="section newsletter-section" aria-labelledby="newsletter-heading">
                <div className="container text-center">
                    ...
                    <p>Join thousands of readers who stay ahead with our daily highlights.</p>
